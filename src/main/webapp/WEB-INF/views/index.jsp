...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    ...
                    <div class="logo-element">dancheng</div>
                </li>
                <li>
                    <a class="J_menuItem" href="${pageContext.request.contextPath}/user/list">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="${pageContext.request.contextPath}/university/index">大学信息</a>
                        </li>
                    </ul>
                </li>
            </ul>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="https://baike.baidu.com/item/%E5%8D%9A%E9%9B%85%E9%A2%86%E8%88%AA%E6%95%99%E8%82%B2%E5%92%A8%E8%AF%A2%EF%BC%88%E5%8C%97%E4%BA%AC%EF%BC%89%E6%9C%89%E9%99%90%E5%85%AC%E5%8F%B8/22558255?fr=aladdin" frameborder="0" data-id="index" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2018-12-18
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<script src="${pageContext.request.contextPath}/static/js/plugins/layerui/layer.js"></script>
<script src="${pageContext.request.contextPath}/static/js/hplus.min.js"></script>

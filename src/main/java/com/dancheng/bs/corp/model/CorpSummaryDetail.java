package com.dancheng.bs.corp.model;

public class CorpSummaryDetail {
    ...
    public void setUserperson(String userperson) {
        this.userperson = userperson == null ? null : userperson.trim();
    }
    ...
    public void setRecivetime(String recivetime) {
        this.recivetime = recivetime == null ? null : recivetime.trim();
    }
    ...
    public void setSavepoint(String savepoint) {
        this.savepoint = savepoint == null ? null : savepoint.trim();
    }
    ...
    public void setSavestate(String savestate) {
        this.savestate = savestate == null ? null : savestate.trim();
    }
